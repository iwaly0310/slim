...
const ctaBand = () => `<section class="band">
  <div>
    <h2>減重不是一個人的事</h2>
    <p>在宏謙，醫師、營養師與個管師分工照顧：醫師評估與調整治療，營養師在用藥前與用藥一個多月後各做一次飲食規劃，個管師定期關心、幫您算好每天該喝的水量。</p>
  </div>
  <a class="btn light" href="${site.clinic.line}">用 LINE 預約評估</a>
</section>`;
...
<section class="journey">
  ...
  <ol class="steps">
    <li><b>啟動期</b><span>用藥最初一到兩個月。重點是把噁心、便祕、注射部位反應這些常見不適處理好，讓治療穩定開始。</span></li>
    <li><b>優化期</b><span>體重開始明顯下降。重點是蛋白質吃到份數、補足營養，保住肌肉、減少掉髮，同時開始安排運動。</span></li>
    <li><b>維持期</b><span>兩個月之後。重點是把阻力運動變成習慣，讓體重、血糖、血脂、血壓在停藥或減量後仍然穩定。</span></li>
  </ol>
</section>
